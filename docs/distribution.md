...
- Canonical development and change tracking:
  <https://git.dannyhunn.com/agents/gotth-infrastructure>
- Public clone, Go import, and future releases:
  <https://github.com/gotthboard/gotth-infrastructure>
...
Current status: unreleased Go library and CLI.
...
```go
import ops "github.com/gotthboard/gotth-infrastructure"
```
